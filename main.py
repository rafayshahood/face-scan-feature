...
from maskedFrame import create_masked_frame, visualize_oval
...
# Set the frame size based on a percentage of screen size
# frame_size = (int(screen_width * 0.4), int(screen_height))  # 40% width, 100% height
